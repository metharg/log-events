...
```shell
git clone https://github.com/metharg/log-events.git
```

2. Open the project in an IDE of your choice.
3. Run the main application - `com.logger.events.LogEventMain`.
    1. Create/Update the Run Configuration for the class to provide the program argument.<br />
       <br />
       A sample log file is available in `resources/logsamples/logfile.txt`
